        ...
        function(req, username, password, done) {
            ...
            connection.query("SELECT * FROM users WHERE login = ?",[username], function(err, rows) {
                ...
                if (rows.length) {
                    ...
                    var insertQuery = "INSERT INTO users ( login, password,status ) values (?,?,?)";

                    connection.query(insertQuery,[newUserMysql.login, newUserMysql.password, newUserMysql.status],function(err, rows) {
